...
public class PageIndicatorView2 extends View implements IndicatorManager.Listener, View.OnTouchListener {
     ...
     * manually if this is true. Alpha is used to manage fading and appearance of {@link PageIndicatorView2} and
     * value you provide
     ...
     * Minimum and maximum values are {@link ScaleAnimation#MAX_SCALE_FACTOR} and
     * {@link ScaleAnimation#MIN_SCALE_FACTOR}.
    ...
    /**
     * Set color of unselected state to each circle indicator. Default color
     * {@link ColorAnimation#DEFAULT_UNSELECTED_COLOR}.
     *
    ...
    /**
     * Set animation duration time in millisecond. Default animation duration time is
     * {@link BaseAnimation#DEFAULT_ANIMATION_TIME}.
    ...
    /**
     * Set specific circle indicator position to be selected without any kind of animation. If position < or > total
     * count,
     * accordingly first or last circle indicator will be selected.
     *
     * @param position position of indicator to select.
